...
img_directory_training = '../../Data/training_images'
img_directory_test = '../../Data/test_images'
...
if __name__ == "__main__":
    ...
    print(x.shape,text_features.shape,img_features.shape)
    print(f"Index {i}, Label: {label}, text: {text}, img: {img}")
    Image.open(img)